...
class ThreadTest extends TestCase
{
    public function testGetOtherParticipants(): void
    {
        ...
        $toIds = (fn(array $participants): array => array_map(fn(ParticipantInterface $participant): string|int|null => $participant->getId(), $participants));
    ...
    private function createParticipantMock(int $id): \PHPUnit\Framework\MockObject\MockObject
    {
